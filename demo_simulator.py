"""
============================================================================
 DEMO SIMULATOR — SIMULATED DATA ONLY. NOT PART OF THE REAL PIPELINE.
============================================================================
This script emits RANDOM, FABRICATED trust/risk values and narratives purely
to exercise the Grafana dashboard when you have no live traffic. It does NOT
read from the detection pipeline or the database.

DO NOT run this alongside the real app on the same Prometheus target, and DO
NOT present any numbers it produces as experimental results.

It listens on :8001 (the real app owns :8000). To use it, uncomment the
"cloudsentinel-demo-sim" job in prometheus.yml.
============================================================================
"""
...
def run_security_pipeline():
    print("Multi-Engine Security Metrics Server running on http://localhost:8001/metrics")
